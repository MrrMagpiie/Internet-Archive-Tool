...
class GUIManager(QObject):
    ...
    def run_setup(self,need_setup):
        if need_setup:
            ...
            # 1. Connect the Page 1 action to your IA scraping logic
            wizard.ia_creds_request.connect(self.process_manager.ia_config)
            
            # 2. Connect the Final Page action to your new Database admin creation logic
            wizard.admin_setup_data.connect(self.process_manager.new_user)
